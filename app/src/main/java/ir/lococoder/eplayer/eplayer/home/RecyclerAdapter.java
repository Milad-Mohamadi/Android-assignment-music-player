...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
  ...
  public RecyclerAdapter(Context context, ArrayList<LRecyclerStruct> list) {
    this.list = list;
  ...
  public void onBindViewHolder(final ViewHolder holder, int position) {
    ...
    switch (cellType) {
      case TYPE_EPISODE:
        final RecyclerInfo value_item = (RecyclerInfo) list.get(position);
...
//        setJustify(context,holder.root_description,value_item.description);
        ...
        holder.txt_episode_duration.setText(value_item.all_rate+"");
