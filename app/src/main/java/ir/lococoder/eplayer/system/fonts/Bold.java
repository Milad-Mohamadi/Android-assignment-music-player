...
import static ir.lococoder.eplayer.system.fonts.FontStruct.FONT_PERSIAN_BOLD;
...
public class Bold extends AppCompatTextView {
  ...
  public void init() {
    ...
    Typeface tf = Typeface.createFromAsset(getContext().getAssets(), "fonts/"+FONT_PERSIAN_BOLD+".ttf");
    setTypeface(tf);
    }else{
