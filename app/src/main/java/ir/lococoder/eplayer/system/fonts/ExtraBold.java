...
public class ExtraBold extends AppCompatTextView {

  public ExtraBold(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs, defStyle);
    init();
  }

  public ExtraBold(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }

  public ExtraBold(Context context) {
    super(context);
    init();
  }
